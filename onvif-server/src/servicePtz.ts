...
export class PtzService {
	...
	public readonly serviceName = "ptz";

	constructor(server: OnvifServer) {
		server.registerMethod(this.serviceName, 'getPresets', (args: any) => this.getPresets(args));
		server.registerMethod(this.serviceName, 'getNodes', (args: any) => this.getNodes(args));

		server.registerMethod(this.serviceName, 'gotoPreset', (args: any) => this.gotoPreset(args));
		server.registerMethod(this.serviceName, 'gotoHomePosition', (args: any) => this.gotoHomePosition(args));
    }

	private getPresets(args: any): string {

		console.log("getPresets(): " + util.inspect(args, false, null, true));
    ...
    private getNodes(args: any): string {

		console.log("getNodes(): " + util.inspect(args, false, null, true));
		return `
    ...
    private gotoPreset(args: any): string {

		console.log("gotoPreset(): " + util.inspect(args, false, null, true));
    ...
    private gotoHomePosition(args: any): string {

		console.log("gotoHomePosition(): " + util.inspect(args, false, null, true));
